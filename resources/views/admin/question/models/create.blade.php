...
@section('content')
    <div class="kt-portlet">
        ...
        {{ html()->modelForm(null, 'post')->route('admin.question.model.store')->class('kt-form kt-form--label-right')->open() }}
            @include('admin.question.models.form', ['formAction' => 'Save'])
        {{ html()->closeModelForm() }}
    </div>
@endsection
