...
@section('scripts')
    ...
    <script>
        ...
        function displayConfirmationData() {
            ...
            var program = $("#sub-faculty option:selected").text();
        ...
        $(document).ready(function() {
            ...
            $("#category").change(function() {
                ...
                if (categoryId) {
                    $.ajax({
                        url: '{{ route('categories.faculties', ': category') }}'.replace(
                            ':category',
                            categoryId),
                        type: 'GET',
                        success: function(response) {
            ...
            $("#faculty").change(function() {
                ...
                if (facultyId) {
                    $.ajax({
                        url: '{{ route('faculties.subFaculties', ': faculty') }}'.replace(
                            ':faculty',
                            facultyId),
                        type: 'GET',
                        success: function(response) {
            ...
            $("#sub-faculty").change(function() {
                ...
                if (subFacultyId) {
                    $.ajax({
                        url: '{{ route('subFaculties.subjects', ': subFaculty') }}'.replace(
                            ':subFaculty',
                            subFacultyId),
                        type: 'GET',
                        success: function(response) {
